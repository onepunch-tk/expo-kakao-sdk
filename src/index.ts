...
import { ChangeEventPayload, ExpoKakaoSdkViewProps } from './ExpoKakaoSdk.types';
...
const emitter = new EventEmitter(ExpoKakaoSdkModule ?? NativeModulesProxy.ExpoKakaoSdk);
